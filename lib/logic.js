...
const shape_1 = __importDefault(require("./curve/shape"));
const grade_1 = __importDefault(require("./curve/grade"));
const reverse_grade_1 = __importDefault(require("./curve/reverse-grade"));
const triangle_1 = __importDefault(require("./curve/triangle"));
const trapezoid_1 = __importDefault(require("./curve/trapezoid"));
const constant_1 = __importDefault(require("./curve/constant"));
const fuzzy_function_1 = __importDefault(require("./curve/fuzzy-function"));
const sigmoid_1 = __importDefault(require("./curve/sigmoid"));
...
class Logic {
    ...
    constructor() {
        this.c = {
            ...
            ReverseGrade: reverse_grade_1.default,
            Trapezoid: trapezoid_1.default,
            Triangle: triangle_1.default,
            Constant: constant_1.default,
            FuzzyFunction: fuzzy_function_1.default,
            Sigmoid: sigmoid_1.default
        };
    }
    checkInitCalled() {
        if (!this.initCalled) {
